...
describe("Fraction Program", () => {
  ...
  // Shared test setup
  let sharedFractionName: string;
  let sharedFractionConfigPda: PublicKey;
  ...
  before(async () => {
    ...
    [sharedFractionConfigPda] = PublicKey.findProgramAddressSync(
      [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(sharedFractionName)],
      program.programId
    );
    ...
    for (let i = 0; i < 5; i++) {
      const [pda] = PublicKey.findProgramAddressSync(
        [Buffer.from("balance"), sharedFractionConfigPda.toBuffer(), participants[i].publicKey.toBuffer()],
        program.programId
      );
    ...
    [sharedBotBalancePda] = PublicKey.findProgramAddressSync(
      [Buffer.from("bot_balance"), sharedFractionConfigPda.toBuffer(), botWallet.publicKey.toBuffer()],
      program.programId
    );
  });
    ...
    try {
      const tx = await program.methods
        ...
        .accountsPartial({
          ...
          fractionConfig: sharedFractionConfigPda,
      ...
      // Verify
      const fractionConfig = await program.account.fractionConfig.fetch(sharedFractionConfigPda);
  ...
  it("Should update fraction configuration", async () => {
    try {
      ...
      const updateTx = await program.methods
        .updateFraction(sharedFractionName, newParticipants, botWallet.publicKey)
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: sharedFractionConfigPda,
        })
      ...
      // Verify
      const updatedConfig = await program.account.fractionConfig.fetch(sharedFractionConfigPda);
  ...
  //       .claimAndDistribute(sharedFractionName)
  //       .accountsPartial({
  //         authority: authority.publicKey,
  ...
  it("Should create treasury account on client side", async () => {
    try {
      ...
      expect(treasuryAccount.owner.toString()).to.equal(sharedFractionConfigPda.toString());
  ...
  it("Should reject unauthorized update attempt", async () => {
    try {
      ...
      try {
        await program.methods
          .updateFraction(sharedFractionName, maliciousParticipants, botWallet.publicKey)
          .accountsPartial({
    ...
    try {
      ...
      for (let i = 0; i < 5; i++) {
        const withdrawTx = await program.methods
          .withdrawShare(sharedFractionName)
          .accountsPartial({
            authority: authority.publicKey,
  ...
  it("Should verify contract state consistency", async () => {
    try {
      ...
      const config = await program.account.fractionConfig.fetch(sharedFractionConfigPda);
      expect(config.authority.toString()).to.equal(authority.publicKey.toString());
      expect(config.name).to.equal(sharedFractionName);
      ...
      for (let i = 0; i < 5; i++) {
        ...
        expect(balance.fraction.toString()).to.equal(sharedFractionConfigPda.toString());
      ...
      expect(botBalance.fraction.toString()).to.equal(sharedFractionConfigPda.toString());
  ...
  it("Should reject invalid share distributions", async () => {
    try {
      ...
      try {
        await program.methods
          .updateFraction(sharedFractionName, invalidParticipants1, botWallet.publicKey)
          .accountsPartial({
            authority: authority.publicKey,
            fractionConfig: sharedFractionConfigPda,
          })
      ...
      try {
        await program.methods
          .updateFraction(sharedFractionName, invalidParticipants2, botWallet.publicKey)
          .accountsPartial({
            authority: authority.publicKey,
            fractionConfig: sharedFractionConfigPda,
          })
      ...
      try {
        await program.methods
          .updateFraction(sharedFractionName, invalidParticipants3, botWallet.publicKey)
          .accountsPartial({
            authority: authority.publicKey,
            fractionConfig: sharedFractionConfigPda,
          })
  ...
  it("Should handle duplicate participant wallets", async () => {
    try {
      ...
      try {
        await program.methods
          .updateFraction(sharedFractionName, duplicateParticipants, botWallet.publicKey)
          .accountsPartial({
            authority: authority.publicKey,
            fractionConfig: sharedFractionConfigPda,
          })
  ...
  it("Should prevent bot wallet conflicts", async () => {
    try {
      ...
      try {
        await program.methods
          .updateFraction(sharedFractionName, conflictingParticipants, participants[0].publicKey)
          .accountsPartial({
            authority: authority.publicKey,
            fractionConfig: sharedFractionConfigPda,
          })
  ...
  it("Should handle arithmetic overflow scenarios", async () => {
    try {
      ...
      const [maxFractionConfigPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(maxSplitterName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: maxFractionConfigPda,
          participantBalance0: PublicKey.findProgramAddressSync(
            [Buffer.from("balance"), maxFractionConfigPda.toBuffer(), participants[0].publicKey.toBuffer()],
            program.programId
          )[0],
          participantBalance1: PublicKey.findProgramAddressSync(
            [Buffer.from("balance"), maxFractionConfigPda.toBuffer(), participants[1].publicKey.toBuffer()],
            program.programId
          )[0],
          participantBalance2: PublicKey.findProgramAddressSync(
            [Buffer.from("balance"), maxFractionConfigPda.toBuffer(), participants[2].publicKey.toBuffer()],
            program.programId
          )[0],
          participantBalance3: PublicKey.findProgramAddressSync(
            [Buffer.from("balance"), maxFractionConfigPda.toBuffer(), participants[3].publicKey.toBuffer()],
            program.programId
          )[0],
          participantBalance4: PublicKey.findProgramAddressSync(
            [Buffer.from("balance"), maxFractionConfigPda.toBuffer(), participants[4].publicKey.toBuffer()],
            program.programId
          )[0],
          botBalance: PublicKey.findProgramAddressSync(
            [Buffer.from("bot_balance"), maxFractionConfigPda.toBuffer(), botWallet.publicKey.toBuffer()],
            program.programId
          )[0],
          systemProgram: SystemProgram.programId,
        })
  ...
  it("Should handle unauthorized bot distribution attempts", async () => {
    try {
      ...
      const [unauthorizedSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(unauthorizedName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: unauthorizedSplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle insufficient balance withdrawals", async () => {
    try {
      ...
      const [insufficientSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(insufficientName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: insufficientSplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle wrong participant withdrawal attempts", async () => {
    try {
      ...
      const [wrongParticipantSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(wrongParticipantName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: wrongParticipantSplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle multiple distribution rounds", async () => {
    try {
      ...
      const [multiRoundSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(multiRoundName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: multiRoundSplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
    ...
    try {
      ...
      try {
        await program.methods
          ...
          .accountsPartial({
            authority: authority.publicKey,
            fractionConfig: PublicKey.findProgramAddressSync(
              [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(longName)],
              program.programId
            )[0],
            participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle concurrent withdrawal attempts", async () => {
    try {
      ...
      const [concurrentSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(concurrentName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          authority: authority.publicKey,
          fractionConfig: concurrentSplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle NoFundsToDistribute error with empty treasury", async () => {
    try {
      ...
      const [emptyTreasurySplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), emptyTreasuryAuthority.publicKey.toBuffer(), Buffer.from(emptyTreasuryName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          ...
          fractionConfig: emptyTreasurySplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  //       [Buffer.from("fraction_config"), authority.publicKey.toBuffer(), Buffer.from(mismatchName)],
  //       program.programId
  //     );
  ...
  //         .accountsPartial({
  //           authority: authority.publicKey,
  //           fractionConfig: mismatchSplitterPda,
  //           participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle ArithmeticOverflow edge cases", async () => {
    try {
      ...
      const [overflowSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), overflowAuthority.publicKey.toBuffer(), Buffer.from(overflowName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          ...
          fractionConfig: overflowSplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle Treasury balance edge cases", async () => {
    try {
      ...
      const [treasurySplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), treasuryAuthority.publicKey.toBuffer(), Buffer.from(treasuryName)],
        program.programId
      );
      ...
      await program.methods
        ...
        .accountsPartial({
          ...
          fractionConfig: treasurySplitterPda,
          participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle Account size limits", async () => {
    try {
      ...
      const [maxNameSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), maxNameAuthority.publicKey.toBuffer(), Buffer.from(maxName)],
        program.programId
      );
      ...
      try {
        await program.methods
          ...
          .accountsPartial({
            ...
            fractionConfig: maxNameSplitterPda,
            participantBalance0: PublicKey.findProgramAddressSync(
  ...
  it("Should handle Concurrent operations edge cases", async () => {
    try {
      ...
      const [concurrentSplitterPda] = PublicKey.findProgramAddressSync(
        [Buffer.from("fraction_config"), concurrentAuthority.publicKey.toBuffer(), Buffer.from(concurrentName)],
        program.programId
      );
