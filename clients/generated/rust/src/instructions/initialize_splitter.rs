...
pub const INITIALIZE_SPLITTER_DISCRIMINATOR: [u8; 8] = [81, 111, 81, 77, 41, 36, 149, 189];

/// Accounts.
#[derive(Debug)]
pub struct InitializeSplitter {
...
impl InitializeSplitter {
  pub fn instruction(&self, args: InitializeSplitterInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeSplitterInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InitializeSplitterInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeSplitterInstructionData {
            discriminator: [u8; 8],
                                                      }

impl InitializeSplitterInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [81, 111, 81, 77, 41, 36, 149, 189],
                                                                                                                                  }
  }
}

impl Default for InitializeSplitterInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeSplitterInstructionArgs {
                  pub name: String,
...
/// Instruction builder for `InitializeSplitter`.
///
/// ### Accounts:
///
...
pub struct InitializeSplitterBuilder {
...
impl InitializeSplitterBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = InitializeSplitter {
          ...
          let args = InitializeSplitterInstructionArgs {
  ...
  /// `initialize_splitter` CPI accounts.
  pub struct InitializeSplitterCpiAccounts<'a, 'b> {
...
/// `initialize_splitter` CPI instruction.
pub struct InitializeSplitterCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: InitializeSplitterInstructionArgs,
  }

impl<'a, 'b> InitializeSplitterCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: InitializeSplitterCpiAccounts<'a, 'b>,
              args: InitializeSplitterInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `InitializeSplitter` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   8. `[]` system_program
#[derive(Clone, Debug)]
pub struct InitializeSplitterCpiBuilder<'a, 'b> {
  instruction: Box<InitializeSplitterCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializeSplitterCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeSplitterCpiBuilderInstruction {
      __program: program,
              authority: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitializeSplitterCpi {
...
#[derive(Clone, Debug)]
struct InitializeSplitterCpiBuilderInstruction<'a, 'b> {
