...
pub enum SplitsError {
    ...
    /// 6010 - Provided name does not match splitter config name
    #[error("Provided name does not match splitter config name")]
    NameMismatch = 0x177A,
...
impl From<SplitsError> for solana_program_error::ProgramError {
